...
Code Connect files are TypeScript files that map Figma components to code components. They should be placed in a `figma-code-connect/` directory at the root of your project.
      ...
      render: (props) => (
        <Dialog>
          ...
          <DialogContent>
            ...
            <DialogDescription>
              {props.description || "Dialog description"}
            </DialogDescription>
            <DialogClose asChild>
