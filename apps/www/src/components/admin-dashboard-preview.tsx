...
function DashboardSkeleton() {
  return (
    <div className="space-y-6 p-6" data-admin-root>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="rounded-lg border border-[color:var(--color-border-base)] bg-[color:var(--color-surface-1)] p-6 space-y-3"
          >
      ...
      {/* Chart Skeleton */}
      <div className="rounded-lg border border-[color:var(--color-border-base)] bg-[color:var(--color-surface-1)] p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
