  ...
  return (
    <DocLayout>
      <div className="flex items-center justify-between mb-[var(--space-1)]">
        <h1 id="theming" className="text-[length:var(--typography-display-md-size)] font-medium">Theming &amp; Modes</h1>
      ...
      <div className="space-y-[var(--space-4)] my-[var(--space-6)]">
        <div className="flex gap-[var(--space-2)] flex-wrap">
          <Button 
            variant={mounted && theme === "dark" ? "solid" : "outline"}
            onClick={() => {
              setTheme("dark");
            }}
          >
          ...
          <Button 
            variant={mounted && theme === "light" ? "solid" : "outline"}
            onClick={() => {
              setTheme("light");
            }}
          >
          ...
          <Button 
            variant={mounted && theme === "system" ? "solid" : "outline"}
            onClick={() => {
              setTheme("system");
            }}
          >
...
/* These automatically flip in RTL */`}</CodeBlock>
  ...
  lang="ar"
>
  <!-- Dark theme, comfortable density, reduced motion, RTL layout -->
</html>`}</CodeBlock>
