    ...
    <DocumentContent as="article">
      ...
      <div className="mt-[var(--space-4)] border border-[color:var(--color-border-base)] rounded-[var(--radius-lg)] overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>Rating</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>value?, defaultValue?, onChange?, max?, half?, readOnly?, size?, disabled?, showValue?, allowClear?, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]">—</td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Star rating component for capturing user scores</td>
            </tr>
          </tbody>
        </table>
      </div>
