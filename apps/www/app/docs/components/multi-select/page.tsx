...
export default function MultiSelectPage() {
  ...
  return (
    <DocumentContent as="article">
      ...
      <p className="mb-[var(--space-6)] intro-text">Choose multiple options from a list.</p>
      ...
      <div className="mt-[var(--space-4)] border border-[color:var(--color-border-base)] rounded-[var(--radius-lg)] overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>MultiSelect</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>options?, value?, onValueChange?, placeholder?, searchPlaceholder?, emptyText?, maxCount?, className?, disabled?, clearable?, loading?, asyncOptions?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]">—</td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Multi-select component with search and tag display</td>
            </tr>
          </tbody>
        </table>
      </div>
