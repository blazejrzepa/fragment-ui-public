...
export default function ToggleGroupPage() {
  return (
    <DocumentContent as="article">
      ...
      <p className="mb-[var(--space-6)] intro-text">Manage multiple related toggles together.</p>
      ...
      <div className="mt-[var(--space-4)] border border-[color:var(--color-border-base)] rounded-[var(--radius-lg)] overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ToggleGroup</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>type, value?, defaultValue?, onValueChange?, variant?, spacing?, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]">variant: "outline", spacing: "default"</td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Container for toggle group items</td>
            </tr>
            <tr>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ToggleGroupItem</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>value, variant?, spacing?, disabled?, aria-label?, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]">variant: "outline", spacing: "default"</td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Individual toggle item</td>
            </tr>
          </tbody>
        </table>
      </div>
