    ...
    <DocumentContent as="article">
      ...
      <div className="mt-4 border border-[color:var(--color-border-base)] rounded-lg overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4"><code>Stepper</code></td>
              <td className="py-2 px-4"><code>steps, currentStep, orientation?, clickable?, onStepClick?, showLabels?, showDescriptions?, className?</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Multi-step progress indicator component</td>
            </tr>
          </tbody>
        </table>
      </div>
