  ...
  return (
    <DocumentContent as="article">
      <div className="flex items-center gap-[var(--space-4)] mb-[var(--space-1)]">
        <h1 id="metric-card" className="text-[length:var(--typography-display-md-size)] font-medium">Metric Card</h1>
      </div>
      <p className="mb-[var(--space-6)] intro-text">Display a key metric with trend.</p>
      ...
      >
        <div className="flex gap-[var(--space-2)] items-center justify-center w-full">
          <div className="flex flex-col gap-[var(--space-8)] w-full max-w-md">
            ...
            <div className="flex flex-col gap-[var(--space-4)]">
              <p className="text-[length:var(--typography-size-sm)]" style={{ color: "var(--color-fg-muted)" }}>With Trend Badge</p>
              <MetricCard
                title="New Subscriptions"
                value="4,682"
                description="Since Last week"
            ...
            <div className="flex flex-col gap-[var(--space-4)]">
              <p className="text-[length:var(--typography-size-sm)]" style={{ color: "var(--color-fg-muted)" }}>With Icon</p>
              <MetricCard
                title="Total Revenue"
                value="$15,231.89"
                description="Since Last week"
      ...
      <div className="mt-[var(--space-4)] border border-[color:var(--color-border-base)] rounded-[var(--radius-lg)] overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>MetricCard</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>title, value, icon?, trend?, trendValue?, description?, footer?, footerPlacement?, onClick?, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]">—</td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Card component for displaying KPIs and metrics</td>
            </tr>
          </tbody>
        </table>
      </div>
