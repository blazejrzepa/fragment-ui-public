        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr>
              ...
              <td className="py-2 px-4 text-sm">Controlled array of tag strings (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>defaultValue?</code></td>
              <td className="py-2 px-4"><code>string[]</code></td>
              <td className="py-2 px-4">[]</td>
              <td className="py-2 px-4 text-sm">Default array of tag strings (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>onChange?</code></td>
              <td className="py-2 px-4"><code>(tags: string[]) {'=>'} void</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Callback when tags change (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>placeholder?</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">"Add tags..."</td>
              <td className="py-2 px-4 text-sm">Placeholder text (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>disabled?</code></td>
              <td className="py-2 px-4"><code>boolean</code></td>
              <td className="py-2 px-4">false</td>
              <td className="py-2 px-4 text-sm">Disable the input (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>maxTags?</code></td>
              <td className="py-2 px-4"><code>number</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Maximum number of tags allowed (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>maxLength?</code></td>
              <td className="py-2 px-4"><code>number</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Maximum length per tag (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>separator?</code></td>
              <td className="py-2 px-4"><code>string | RegExp</code></td>
              <td className="py-2 px-4">/[,\s]+/</td>
              <td className="py-2 px-4 text-sm">Separator to split tags (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>allowDuplicates?</code></td>
              <td className="py-2 px-4"><code>boolean</code></td>
              <td className="py-2 px-4">false</td>
              <td className="py-2 px-4 text-sm">Allow duplicate tags (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>validate?</code></td>
              <td className="py-2 px-4"><code>(tag: string) {'=>'} boolean | string</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Validation function (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>onTagAdd?</code></td>
              <td className="py-2 px-4"><code>(tag: string) {'=>'} void</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Callback when a tag is added (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>onTagRemove?</code></td>
              <td className="py-2 px-4"><code>(tag: string) {'=>'} void</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Callback when a tag is removed (optional)</td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="py-2 px-4"><code>inputClassName?</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Additional CSS classes for input (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>tagClassName?</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Additional CSS classes for tags (optional)</td>
            </tr>
          </tbody>
        </table>
      </div>
