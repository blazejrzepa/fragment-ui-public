    ...
    <DocumentContent as="article">
      ...
      <div className="mt-4 border border-[color:var(--color-border-base)] rounded-lg overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>QuickActions</code></td>
              <td className="py-2 px-4"><code>actions, columns?, layout?, className?</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Component for displaying shortcut actions in grid or list layout</td>
            </tr>
          </tbody>
        </table>
      </div>
