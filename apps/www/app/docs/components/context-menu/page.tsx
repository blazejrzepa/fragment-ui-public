  ...
  return (
    <DocumentContent as="article">
      <div className="flex items-center gap-[var(--space-4)] mb-[var(--space-1)]">
        <h1 id="context-menu" className="text-[length:var(--typography-display-md-size)] font-medium">Context Menu</h1>
      </div>
      <p className="mb-[var(--space-6)] intro-text">Show actions based on right-click context.</p>
      ...
      >
        <div className="flex gap-[var(--space-2)] items-center justify-center w-full">
          ...
          <div className="flex flex-col gap-[var(--space-4)]">
            ...
            <ContextMenu>
              <ContextMenuTrigger className="flex h-[150px] w-full items-center justify-center rounded-[var(--radius-md)] border border-dashed border-[color:var(--color-border-base)] text-[length:var(--typography-size-sm)]">
                Right click here
              </ContextMenuTrigger>
              <ContextMenuContent>
                <ContextMenuItem>Back</ContextMenuItem>
          ...
          <div className="flex flex-col gap-[var(--space-4)]">
            <p className="text-[length:var(--typography-size-sm)]" style={{ color: "var(--color-fg-muted)" }}>With Submenu</p>
            <ContextMenu>
              <ContextMenuTrigger className="flex h-[150px] w-full items-center justify-center rounded-[var(--radius-md)] border border-dashed border-[color:var(--color-border-base)] text-[length:var(--typography-size-sm)]">
                Right click here
              </ContextMenuTrigger>
      ...
      <div className="mt-[var(--space-4)] border border-[color:var(--color-border-base)] rounded-[var(--radius-lg)] overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenu</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>modal?, onOpenChange?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Root component. Must contain <code>ContextMenuTrigger</code> and <code>ContextMenuContent</code></td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuTrigger</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>asChild?, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Trigger element that opens the menu on right-click</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuContent</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>align?, side?, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Container for menu items</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuItem</code></td>
            ...
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuCheckboxItem</code></td>
            ...
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuRadioItem</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>value, className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Menu item with radio state (use within <code>ContextMenuRadioGroup</code>)</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuLabel</code></td>
            ...
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuSeparator</code></td>
            ...
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuShortcut</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>className?</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Keyboard shortcut display (e.g., "⌘P")</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuSub</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]">—</td>
              <td className="py-[var(--space-2)] px-[var(--space-4)] text-[length:var(--typography-size-sm)]">Container for submenu (use with <code>ContextMenuSubTrigger</code> and <code>ContextMenuSubContent</code>)</td>
            </tr>
            <tr>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>ContextMenuSubTrigger</code></td>
              <td className="py-[var(--space-2)] px-[var(--space-4)]"><code>inset?, className?</code></td>
