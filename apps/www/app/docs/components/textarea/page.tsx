        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr>
              ...
              <td className="py-2 px-4 text-sm">Controlled value (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>defaultValue?</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Default value (optional)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-2 px-4 text-sm">Disable the textarea (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>rows?</code></td>
              <td className="py-2 px-4"><code>number</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Number of visible rows (optional)</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>error?</code></td>
              <td className="py-2 px-4"><code>boolean</code></td>
              <td className="py-2 px-4">false</td>
              <td className="py-2 px-4 text-sm">Show error state (optional)</td>
            </tr>
            <tr>
