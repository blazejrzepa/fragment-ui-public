...
export default function CommandPalettePage() {
  ...
  return (
    <DocumentContent as="article">
      ...
      <p className="mb-6 intro-text">Run actions quickly via search and shortcuts.</p>
      ...
      <div className="mt-4 border border-[color:var(--color-border-base)] rounded-lg overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>actions</code></td>
              <td className="py-2 px-4"><code>CommandPaletteAction[]</code></td>
              <td className="py-2 px-4"><code>[]</code></td>
              <td className="py-2 px-4 text-sm">Array of action objects (required)</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>trigger</code></td>
              <td className="py-2 px-4"><code>React.ReactNode</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Custom trigger element (optional, defaults to Button)</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>placeholder</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4"><code>"Type a command or search..."</code></td>
            ...
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>showRecentCommands</code></td>
              <td className="py-2 px-4"><code>boolean</code></td>
              <td className="py-2 px-4"><code>true</code></td>
              <td className="py-2 px-4 text-sm">Show recent commands section</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>maxRecentCommands</code></td>
              <td className="py-2 px-4"><code>number</code></td>
              <td className="py-2 px-4"><code>5</code></td>
              <td className="py-2 px-4 text-sm">Maximum number of recent commands to show</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>recentCommandsStorageKey</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4"><code>"command-palette-recent"</code></td>
              <td className="py-2 px-4 text-sm">localStorage key for storing recent commands</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-4 border border-[color:var(--color-border-base)] rounded-lg overflow-hidden">
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <th className="text-left py-2 px-4 font-semibold text-sm">CommandPaletteAction Property</th>
              <th className="text-left py-2 px-4 font-semibold text-sm">Type</th>
          ...
          <tbody>
            <tr className="border-b border-[color:var(--color-border-base)]">
              ...
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">✓</td>
              <td className="py-2 px-4 text-sm">Unique identifier for the action (required)</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>label</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">✓</td>
              <td className="py-2 px-4 text-sm">Display text for the action (required)</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>keywords</code></td>
              <td className="py-2 px-4"><code>string[]</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Array of search keywords for filtering</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>shortcut</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Keyboard shortcut display (e.g., "⌘N")</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>icon</code></td>
              <td className="py-2 px-4"><code>React.ReactNode</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Icon element to display before the label</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>group</code></td>
              <td className="py-2 px-4"><code>string</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Group name for organizing actions</td>
            </tr>
            <tr className="border-b border-[color:var(--color-border-base)]">
              <td className="py-2 px-4"><code>onSelect</code></td>
              <td className="py-2 px-4"><code>() =&gt; void</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Callback function when action is selected</td>
            </tr>
            <tr>
              <td className="py-2 px-4"><code>children</code></td>
              <td className="py-2 px-4"><code>CommandPaletteAction[]</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Nested actions for hierarchical commands</td>
            </tr>
          </tbody>
        </table>
      </div>
