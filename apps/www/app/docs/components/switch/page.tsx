    ...
    <DocumentContent as="article">
      ...
      <div className="mt-4 border border-[color:var(--color-border-base)] rounded-lg overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4"><code>Switch</code></td>
              <td className="py-2 px-4"><code>checked?, defaultChecked?, onCheckedChange?, disabled?, id?, className?</code></td>
              <td className="py-2 px-4">—</td>
              <td className="py-2 px-4 text-sm">Toggle switch component for binary on/off states</td>
            </tr>
          </tbody>
        </table>
      </div>
