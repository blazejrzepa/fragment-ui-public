...
for (const [name, config] of Object.entries(components)) {
  ...
  if (config.files && Array.isArray(config.files)) {
    ...
    const possiblePaths = [
      path.join(rootDir, "packages/ui/src", `${componentName}.tsx`),
      path.join(rootDir, "packages/ui/src", `${componentName}.jsx`),
      path.join(rootDir, "packages/blocks/src", `${componentName}.tsx`),
      path.join(rootDir, "packages/blocks/src", `${componentName}.jsx`),
    ];
